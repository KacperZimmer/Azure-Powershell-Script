...
$applicationId = "54d885ff-8f00-4636-bf0d-f7004145270e"
...
function UpdateUserProfileAndAddExtension {
    ...
    New-MgGroupMember -GroupId "Tutaj group ID wstawic" -DirectoryObjectId $InvitedUserId
    Write-Host "Użytkownik $InvitedUserId został dodany do grupy $GroupId"
